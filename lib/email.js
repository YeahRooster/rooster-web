...
export async function sendPaymentReminderEmail({ to, name, mesNombre, tipo }) {
    ...
    const html = getEmailTemplate(`
        ...
        <div style="text-align: center; margin-top: 35px;">
            <a href="https://roosterespacio.com.ar/mi-cuenta" style="background-color: #1a1a1a; color: ${color}; padding: 15px 30px; text-decoration: none; font-weight: bold; border-radius: 8px; font-size: 16px;">Ir a Mi Cuenta</a>
        </div>
    `);
