...
// Eliminar el bloque inválido
c = c.replace(/\{showCertModal && editingCertStudent && \([\s\S]*?\/\/ PANEL DEL ALUMNO/, '// PANEL DEL ALUMNO'); 

// Insertarlo dentro del JSX de profesor, justo antes de <div className={styles.teacherGrid}>
