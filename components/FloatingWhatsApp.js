...
export default function FloatingWhatsApp() {
    // Número formateado para API de WhatsApp
    const phoneNumber = "5493425263036"; // Verificado de la imagen (0342) 155-263036 -> 342 + 15 + 5... (Argentina mobile conventions usually drop 15 and add 9 after 54)
    // Re-checking standard: +54 9 (area code) (local number without 15). 
    // If local is 15 5 263 036, then +54 9 342 5 263 036.

    return (
        <div className={styles.container}>
            <a
                href={`https://wa.me/${phoneNumber}?text=Hola!%20Me%20interesa%20saber%20más%20sobre%20los%20talleres.`}
                target="_blank"
